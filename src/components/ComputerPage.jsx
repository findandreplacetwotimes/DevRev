      ...
      <div style={{
        ...
        <div className="conversation-list" style={{ display: "flex", flexDirection: "column", gap: "4px", overflowY: "auto" }}>
          <div className="conversation-item" style={{
            ...
            <div className="conversation-avatars" style={{ display: "flex", gap: "2px" }}>
          ...
          <div className="conversation-item active" style={{
            display: "flex",
            alignItems: "center",
            gap: "8px",
            padding: "6px 8px",
            ...
            cursor: "pointer",
            transition: "background 150ms",
            background: "hsl(var(--bg-neutral-prominent) / 0.1)"
          }}>
            <div className="conversation-label text-system" style={{
              flex: 1,
              color: "hsl(var(--fg-neutral-prominent))",
